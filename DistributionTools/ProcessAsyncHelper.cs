...
namespace DistributionTools
{
    ...
    /// - Source: https://gist.github.com/Indigo744/b5f3bd50df4b179651c876416bf70d0a
    ...
    public static class ProcessAsyncHelper
    {
        ...
        public static async Task<Result> RunAsync(ProcessStartInfo startInfo, Action<string> stdOutDataReceived = null, Action<string> stdErrDataReceived = null, int? timeoutMs = null)
        {
            ...
            using (var process = new Process() { StartInfo = startInfo, EnableRaisingEvents = true })
            {
                ...
                if (process.StartInfo.RedirectStandardOutput)
                {
                    ...
                    process.OutputDataReceived += (s, e) =>
                    {
                        ...
                        else
                        {
                            ...
                            {
                                stdOutDataReceived.Invoke(e.Data);
                            }
                            else
                            {
                ...
                if (process.StartInfo.RedirectStandardError)
                {
                    ...
                    process.ErrorDataReceived += (s, e) =>
                    {
                        ...
                        {
                            if (stdErrDataReceived != null)
                            {
                                stdErrDataReceived.Invoke(e.Data);
                            }
                            else
                            {
